...
def test_machine_rationale_when_no_api_key(settings, factory: sessionmaker, tmp_log_path) -> None:
...
def test_divergence_detected_when_dynamic_differs_from_seed(settings, factory: sessionmaker) -> None:
...
def test_no_scores_today_skips_segment(settings, factory: sessionmaker) -> None:
...
def test_signals_provided_in_context(settings, factory: sessionmaker) -> None:
...
def test_llm_called_for_interesting_segment(settings, factory: sessionmaker) -> None:
